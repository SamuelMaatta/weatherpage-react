...
function TemperatureAndDetails({weather: {details, temp, icon, feels_like, temp_min, temp_max, sunrise, sunset, speed, humidity, timezone}}) {
  return (
    <div className=' px-2 rounded-lg border border-white'>
